...
public class QiniuUtil {
    ...
    public OssSetting getOssSetting(){
        ...
        if(StrUtil.isBlank(v)){
            throw new MinShangException("您还未配置七牛云OSS");
        }
    ...
    public String qiniuUpload(String filePath, String key) {
        ...
        try {
            ...
            throw new MinShangException("上传文件出错，请检查七牛云配置，" + r.toString());
        }
    }
    ...
    public String renameFile(String fromKey, String toKey){
        ...
        try {
            ...
            throw new MinShangException("重命名文件失败，" + ex.response.toString());
        }
    }
    ...
    public String copyFile(String fromKey, String toKey){
        ...
        try {
            ...
            throw new MinShangException("复制文件失败，" + ex.response.toString());
        }
    }
    ...
    public void deleteFile(String key){
        ...
        try {
            ...
            throw new MinShangException("删除文件失败，" + ex.response.toString());
        }
    }
}