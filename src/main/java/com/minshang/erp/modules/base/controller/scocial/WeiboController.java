package com.minshang.erp.modules.base.controller.scocial;
...
import com.minshang.erp.common.vo.AccessToken;
import com.minshang.erp.common.vo.Result;
import com.minshang.erp.common.vo.WeiboUserInfo;
...
@RequestMapping("/minshang/social/weibo")
@Controller
public class WeiboController {

    @Value("${minshang.social.weibo.appKey}")
    private String appKey;

    @Value("${minshang.social.weibo.appSecret}")
    private String appSecret;

    @Value("${minshang.social.weibo.callbackUrl}")
    private String callbackUrl;

    @Value("${minshang.social.callbackFeUrl}")
    private String callbackFeUrl;

    @Value("${minshang.social.callbackFeRelateUrl}")
