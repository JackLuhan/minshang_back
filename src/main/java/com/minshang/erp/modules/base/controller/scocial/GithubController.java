...
import com.minshang.erp.common.vo.GithubUserInfo;
...
@RequestMapping("/minshang/social/github")
@Controller
public class GithubController {

    @Value("${minshang.social.github.clientId}")
    private String clientId;

    @Value("${minshang.social.github.clientSecret}")
    private String clientSecret;

    @Value("${minshang.social.github.callbackUrl}")
