...
import com.minshang.erp.common.vo.QQUserInfo;
...
@RequestMapping("/minshang/social/qq")
@Controller
public class QQController {

    @Value("${minshang.social.qq.appId}")
    private String appId;

    @Value("${minshang.social.qq.appKey}")
    private String appKey;

    @Value("${minshang.social.qq.callbackUrl}")
