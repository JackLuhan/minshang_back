...
-- Records of t_food
-- ----------------------------
INSERT INTO `t_food` VALUES ('92786137470341120', 'admin', '2019-01-02 15:11:20', 0, 0, 'admin', '2019-01-02 15:13:46', '菜品4', '图片4', 1.00, 1, 1, '90624217887805440', '条', '90181532823588864');
...
INSERT INTO `t_organization` VALUES ('92830587361955840', '-1', '合肥市安业餐饮管理有限公司', 'admin', '2019-01-02 18:07:58', 0, 'admin', '2019-01-02 18:07:58', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `t_shop_goods`  (
  ...
  `expend_unit` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `goods_spec` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `shop_unit_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `storage_method` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
